    ...
    <div class="col-md-16">
        ...
        if (isLogeedIn()) {
                    ...
                    <div class="bordered" id="articles">
                        <div class="row">
                            ...
                            <div class="col-sm-16 bt-space sidebar-widget">
                                ...
                                <div class=" show-more">
                                    <a  href="#." id="advance_search">Advance Search &nbsp;<i class="ion-chevron-right" ></i><i class="ion-chevron-right"></i></a>
                                </div>
                                    ...
                                    if ($_REQUEST['search'] == 'Notification') {
                                        ...
                                        <div class="searchbody">
                                            <form name="form2" id="form2" action="adv_search.php" method="GET" class="form padding-b-15" onSubmit="return ValidateForm()">
                                                <input type="hidden" id="sel_type" name="sel_type" value="<?php
                                                if (isset($_REQUEST['type'])) {
                                                    echo $_REQUEST['type'];
                                                }
                                                ?>">
                                                <input type="hidden" id="cat_type" name="cat_type" value="<?php
                                                if (isset($_REQUEST['sub_product_id'])) {
                                                    echo $_REQUEST['sub_product_id'];
                                                }
                                                ?>">  
                                                <input type="hidden" id="st_id" name="st_id" value="<?php
                                           if (isset($_REQUEST['state_id'])) {
                                               echo $_REQUEST['state_id'];
                                           }
                                           ?>"> 
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-11 col-xs-12">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" id="keyword" placeholder="Keyword" name="keyword" value="<?php
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="form-group">
                                                                    <select name="prod_id" id="prod_id" class="form-control">
                                                                        <option value="0" <?php
                                           if (isset($_REQUEST['prod_id']) && ($_REQUEST['prod_id'] == "0")) {
                                               echo "selected=selected";
                                           }
                                                ?> data-dbsuffix="0">Select</option>
                                                                        <option value="10" <?php
                                                                                if (isset($_REQUEST['prod_id']) && ($_REQUEST['prod_id'] == "10")) {
                                                                                    echo "selected=selected";
                                                                                }
                                                                                ?> data-dbsuffix="cgst">CGST</option>
                                                                        <option value="9" <?php
                                                                        if (isset($_REQUEST['prod_id']) && ($_REQUEST['prod_id'] == "9")) {
                                                                            echo "selected=selected";
                                                                        }
                                                                        ?> data-dbsuffix="igst">IGST</option>
                                                                        <option value="7" <?php
                                                                        if (isset($_REQUEST['prod_id']) && ($_REQUEST['prod_id'] == "7")) {
                                                                            echo "selected=selected";
                                                                        }
                                                                        ?> data-dbsuffix="sgst">SGST</option>
                                                                        <option value="1" <?php
                                                                    if (isset($_REQUEST['prod_id']) && ($_REQUEST['prod_id'] == "1")) {
                                                                        echo "selected=selected";
                                                                    }
                                                                    ?> data-dbsuffix="vat">VAT</option>
                                                                        <option value="2" <?php
                                                                    if (isset($_REQUEST['prod_id']) && ($_REQUEST['prod_id'] == "2")) {
                                                                        echo "selected=selected";
                                                                    }
                                                                    ?> data-dbsuffix="st">Service Tax</option>
                                                                        <option value="4" <?php
                                                                    if (isset($_REQUEST['prod_id']) && ($_REQUEST['prod_id'] == "4")) {
                                                                        echo "selected=selected";
                                                                    }
                                                                    ?> data-dbsuffix="ce">Central Excise</option>
                                                                        <option value="5" <?php
                                                                    if (isset($_REQUEST['prod_id']) && ($_REQUEST['prod_id'] == "5")) {
                                                                        echo "selected=selected";
                                                                    }
                                                                    ?> data-dbsuffix="cu">Customs</option>
                                                                        <option value="6" <?php
                                                        if (isset($_REQUEST['prod_id']) && ($_REQUEST['prod_id'] == "6")) {
                                                            echo "selected=selected";
                                                        }
                                                ...
                                                <div class="row">
                                                    <div class="col-md-16">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-11 col-xs-12">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" id="noti_no" placeholder="Notification No." name="noti_no" value="<?php
            if (isset($_REQUEST['noti_no']) && (!empty($_REQUEST['noti_no']))) {
                echo $_REQUEST['noti_no'];
            }
            ?>" />
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-16">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="form-group">
                                                                    <input type="date" class="form-control" id="date" placeholder="Notification Date" name="date" value="<?php
                                                    ...
                                                    <div class="col-md-16 col-xs-16">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 col-xs-7">
                                                                <div class="form-group">
                                                                    <input type="date" class="form-control" id="dt_from" placeholder="" name="dt_from" value="<?php
            if (isset($_REQUEST['dt_from']) && (!empty($_REQUEST['dt_from']))) {
                echo $_REQUEST['dt_from'];
            }
            ?>" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-4 col-xs-7">
                                                                <div class="form-group">
                                                                    <input type="date" class="form-control" id="dt_to" placeholder="" name="dt_to" value="<?php
            if (isset($_REQUEST['dt_to']) && (!empty($_REQUEST['dt_to']))) {
                echo $_REQUEST['dt_to'];
            }
            ?>" />
                                                                </div>
                                        ...
                                        <div class="col-md-16 table-container t-margin-20 searchbody" style="margin: 0;">
                                            <form name="form2" id="form2" action="adv_search.php" method="GET" class="form padding-b-15" onSubmit="return ValidateForm()">  
                                                ...
                                                <div class="col-md-16">   	      			      	
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="text" name="text" value="<?php
            ...
            <?php //search_form  ($HTTP_GET_VARS, $PHP_SELF );   ?>
                                                        <input type="text" class="form-control" id="topic" placeholder="Enter Topic"  name="topic" value="<?php
            ...
            if (isset($_REQUEST['prod_id']) && ($_REQUEST['prod_id'] == 'GST')) {
                echo "selected=selected";
            }
            ?>>GST</option>
                                                            <option value="Others" <?php
                            if (isset($_REQUEST['prod_id']) && ($_REQUEST['prod_id'] == 'Others')) {
                                echo "selected=selected";
                            }
                            ?>>Others</option>
                                                        </select>			
            ...
            <?php echo getAuthor('articles'); ?>
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="date" class="form-control" placeholder="From Date" id="fromDate" name="fromDate" value="<?php
            ...
            ?>"/> 	
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="date" class="form-control" placeholder="To Date"  id="toDate"  name="toDate" value="<?php
                                        ...
                                        <div class="searchbody">
                                            <form name="form2" id="form2" action="adv_search.php" method="GET" class="form padding-b-15" onSubmit="return ValidateForm()">
                                                ...
                                                <input type="hidden" id="dbsuffix" name="dbsuffix" value="<?php
                                                                                if (isset($_REQUEST['dbsuffix']) && (!empty($_REQUEST['dbsuffix']))) {
                                                                                    echo $_REQUEST['dbsuffix'];
                                                                                } else {
                                                                                    echo "";
                                                                                }
                                                                                ?>cgst">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="form-group">
                                                                        <select name="type" id="type" class="form-control">
                                                                            <option value="Acts" <?php
                                                                                if (isset($_REQUEST['type']) && $_REQUEST['type'] == 'Acts') {
                                                                                    echo "selected";
                                                                                }
                                                                                ?>>Acts</option>
                                                                            <option value="Rules" <?php
                                                                    if (isset($_REQUEST['type']) && $_REQUEST['type'] == 'Rules') {
                                                                        echo "selected";
                                                                    }
                                                                    ?>>Rules</option>
                                                                        </select>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    ?> data-dbsuffix="IGST">IGST</option>
                                                                        <option value="7" <?php
                                                                           ...
                                                                           ?> data-dbsuffix="SGST">SGST</option>
                                                                        <option value="8" <?php
                                                                           if (isset($_REQUEST['prod_id']) && ($_REQUEST['prod_id'] == "8")) {
                                                                               echo "selected=selected";
                                                                           }
                                                ...
                                                <div class="row">
                                                    <div class="col-md-16">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" id="keyword" name="keyword" value="<?php
                                                                           if (isset($_REQUEST['keyword']) && !empty($_REQUEST['keyword'])) {
                                                                               echo $_REQUEST['keyword'];
                                                                           }
                                                                           ?>" placeholder="Keyword"/>
                                                    ...
                                                    <div class="col-md-16">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-7  col-xs-12">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" id="section_no" name="section_no" value="<?php
                                                                           if (isset($_REQUEST['section_no']) && !empty($_REQUEST['section_no'])) {
                                                                               echo $_REQUEST['section_no'];
                                                                           }
                                                ...
                                                <div class="row" id="rule" style="display: none;">
                                                    <div class="col-md-16">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-7  col-xs-12">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" id="rule_no" name="rule_no" value="<?php
                                                               if (isset($_REQUEST['rule_no']) && !empty($_REQUEST['rule_no'])) {
                                                                   echo $_REQUEST['rule_no'];
                                                               }
                                                               ?>" placeholder="Rule No."/>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="col-md-16 table-container t-margin-20 searchbody" style="margin: 0;">
                                            <form name="form2" id="form2" action="adv_search.php" method="GET" class="form padding-b-15" onSubmit="return ValidateForm()">  
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="filter_text" name="filter_text" value="<?php
                                                                            if (isset($_REQUEST['filter_text']) && (!empty($_REQUEST['filter_text']))) {
                                                                                echo $_REQUEST['filter_text'];
                                                                            }
                                                                            ?>"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-16">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" placeholder="keyword" id="Keyword" name="Keyword" value="<?php
            if (isset($_REQUEST['Keyword']) && (!empty($_REQUEST['Keyword']))) {
                echo $_REQUEST['Keyword'];
            }
            ?>"/>
                                                            ...
                                                            <div class="col-md-5">
                                                                <div class="row">
                                                                    <div class="col-md-8 col-xs-16 text-center">
                                                                    ...
                                                                    <div class="col-md-8 col-xs-12">
                                                                        <div class="form-group">
                                                                            <select name="search_in" id="search_in" class="form-control">
                                                                                <option value="0" <?php
                                                                                if (isset($_REQUEST['search_in']) && ($_REQUEST['search_in'] == "0")) {
                                                                                    echo "selected=selected";
                                                                                }
                                                                                ?> data-dbsuffix="0">Select </option>	
                                                                                <option value="1" <?php
                                                                                if (isset($_REQUEST['search_in']) && ($_REQUEST['search_in'] == "1")) {
                                                                                    echo "selected=selected";
                                                                                }
                                                                                ?> data-dbsuffix="0">Headnote </option>

                                                                                <option value="2" <?php
                                                                                if (isset($_REQUEST['search_in']) && ($_REQUEST['search_in'] == "2")) {
                                                                                    echo "selected=selected";
                                                                                }
                                                ...
                                                <!-- code added by harshal -->
                                                <div class="row" style="margin-bottom:5px;">
                                                    <div class="col-md-16">
                                                        <div class="row" >
                                                            <div class="col-md-3">
                                                                <label id="searchTypeLabel">&nbsp;</label>
                                                            </div>
                                                            <div class="col-md-8">
                                                                <div class="form-group">
                                                                    <div class="col-md-1">
                                                                        <label id="searchTypeLabel">Exact</label>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <input type="radio" class="form-control" id="exactSearch" 
                                                                               <?php if(($_REQUEST['exact_search']=='exact') || ($_REQUEST['exact_search']=='')) { ?>
                                                                               checked 
                                                                               <?php } ?>
                                                                               
                                                                               name="exact_search" value="exact" style="height:20px;border:0px;margin-top:-1px;box-shadow: 0 0 0 0;">
                                                                        
                                                                    </div>
                                                                    <div class="col-md-1">
                                                                        <label id="searchTypeLabel">Like</label>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <input type="radio" class="form-control" id="exactSearch" 
                                                                               <?php if($_REQUEST['exact_search']=='like') { ?>
                                                                               checked 
                                                                               <?php } ?>
                                                                               
                                                                               name="exact_search" value="like" style="height:20px;border:0px;margin-top:-1px;box-shadow: 0 0 0 0;">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-16">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8 col-xs-12">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" id="party_name" placeholder="Party Name" name="party_name" value="<?php
                                                                                if (isset($_REQUEST['party_name']) && (!empty($_REQUEST['party_name']))) {
                                                                                    echo $_REQUEST['party_name'];
                                                                                }
                                                                                ?>" />
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 col-xs-8">
                                                                <div class="row">
                                                                    <div class="col-md-8">
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control" id="cgst_section" placeholder="" name="cgst_section" value="<?php
                                                                               if (isset($_REQUEST['cgst_section']) && (!empty($_REQUEST['cgst_section']))) {
                                                                                   echo $_REQUEST['cgst_section'];
                                                                               }
                                                                               ?>" onkeypress="return isNumberKey(event)" />
                                                                        </div> 
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <input type="text" class="form-control" id="cgst_section" placeholder="" name="cgst_section1" value="<?php
                                                                               if (isset($_REQUEST['cgst_section1']) && (!empty($_REQUEST['cgst_section1']))) {
                                                                                   echo $_REQUEST['cgst_section1'];
                                                                               }
                                                                               ?>" />
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <input type="text" class="form-control" id="cgst_section2" placeholder="" name="cgst_section2" value="<?php
                                                                               if (isset($_REQUEST['cgst_section2']) && (!empty($_REQUEST['cgst_section2']))) {
                                                                                   echo $_REQUEST['cgst_section2'];
                                                                               }
                                                                               ?>" />
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 col-xs-8">
                                                                <div class="row">
                                                                    <div class="col-md-8">
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control" id="cgst_rule" placeholder="" name="cgst_rule" value="<?php
                                                                                if (isset($_REQUEST['cgst_rule']) && (!empty($_REQUEST['cgst_rule']))) {
                                                                                    echo $_REQUEST['cgst_rule'];
                                                                                }
                                                                                ?>" onkeypress="return isNumberKey(event)"/>
                                                                        </div> 
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <input type="text" class="form-control" id="cgst_rule1" placeholder="" name="cgst_rule1" value="<?php
                                                                        if (isset($_REQUEST['cgst_rule1']) && (!empty($_REQUEST['cgst_rule1']))) {
                                                                            echo $_REQUEST['cgst_rule1'];
                                                                        }
                                                                        ?>" />
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <input type="text" class="form-control" id="cgst_rule2" placeholder="" name="cgst_rule2" value="<?php
                                                                                if (isset($_REQUEST['cgst_rule2']) && (!empty($_REQUEST['cgst_rule2']))) {
                                                                                    echo $_REQUEST['cgst_rule2'];
                                                                                }
                                                                                ?>" />
                                                                    </div>
                                                                </div>
                                                ...
                                                <!-- Code Added by Harshal for IGST SECTION NO and IGST RULE NO --> 
                                                ...
                                                <div class="row">
                                                    <div class="col-md-16">
                                                        <div class="row">
                                                            <div class="col-md-3 col-xs-16">
                                                                <label id="searchTypeLabel">IGST Section No.</label>
                                                            </div>
                                                            <div class="col-md-4 col-xs-8">
                                                                <div class="row">
                                                                    <div class="col-md-8">
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control" id="igst_section" placeholder="" name="igst_section" value="<?php
                                                            if (isset($_REQUEST['igst_section']) && (!empty($_REQUEST['igst_section']))) {
                                                                echo $_REQUEST['igst_section'];
                                                            }
                                                                                ?>" onkeypress="return isNumberKey(event)" />
                                                                        </div> 
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <input type="text" class="form-control" id="igst_section" placeholder="" name="igst_section1" value="<?php
                                                                        if (isset($_REQUEST['igst_section1']) && (!empty($_REQUEST['igst_section1']))) {
                                                                            echo $_REQUEST['igst_section1'];
                                                                        }
                                                                        ?>" />
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <input type="text" class="form-control" id="igst_section2" placeholder="" name="igst_section2" value="<?php
                                                                        if (isset($_REQUEST['igst_section2']) && (!empty($_REQUEST['igst_section2']))) {
                                                                            echo $_REQUEST['igst_section2'];
                                                                        }
                                                                        ?>" />
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-16">
                                                        <div class="row">
                                                            <div class="col-md-3 col-xs-16">
                                                                <label id="searchTypeLabel">IGST Rule No.</label>
                                                            </div>
                                                            <div class="col-md-4 col-xs-8">
                                                                <div class="row">
                                                                    <div class="col-md-8">
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control" id="igst_rule" placeholder="" name="igst_rule" value="<?php
                                                                    if (isset($_REQUEST['igst_rule']) && (!empty($_REQUEST['igst_rule']))) {
                                                                        echo $_REQUEST['igst_rule'];
                                                                    }
                                                                        ?>" onkeypress="return isNumberKey(event)"/>
                                                                        </div> 
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <input type="text" class="form-control" id="igst_rule1" placeholder="" name="igst_rule1" value="<?php
                                                            if (isset($_REQUEST['igst_rule1']) && (!empty($_REQUEST['igst_rule1']))) {
                                                                echo $_REQUEST['igst_rule1'];
                                                            }
                                                                        ?>" />
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <input type="text" class="form-control" id="igst_rule2" placeholder="" name="igst_rule2" value="<?php
                                                                                if (isset($_REQUEST['igst_rule2']) && (!empty($_REQUEST['igst_rule2']))) {
                                                                                    echo $_REQUEST['igst_rule2'];
                                                                                }
                                                                                ?>" />
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-16">
                                                        <div class="row">
                                                            <div class="col-md-3 col-xs-16">
                                                                <label id="searchTypeLabel">Court/Forum</label>
                                                            </div>
                                                            <div class="col-md-9 col-xs-16">
                                                                <div class="form-group">
                                                                    <select id='court' name='court' class="form-control">
                                                                        <option value="0" <?php
                                                                        if (isset($_REQUEST['court']) && ($_REQUEST['court'] == "0")) {
                                                                            echo "selected=selected";
                                                                        }
                                                                        ?>data-dbsuffix="0">Select</option>
                                                                        <option value="SC" <?php
                                                                                if (isset($_REQUEST['court']) && ($_REQUEST['court'] == "SC")) {
                                                                                    echo "selected=selected";
                                                                                }
                                                                                ?>data-dbsuffix="0">Supreme Court</option>
                                                                        <option value="HC" <?php
                                                                                if (isset($_REQUEST['court']) && ($_REQUEST['court'] == "HC")) {
                                                                                    echo "selected=selected";
                                                                                }
                                                                                ?>data-dbsuffix="0">High Court</option>
                                                                        <!-- <option value="TRI" <?php
                                                                                if (isset($_REQUEST['court']) && ($_REQUEST['court'] == "TRI")) {
                                                                                    echo "selected=selected";
                                                                                }
                                                                                ?>data-dbsuffix="0">Tribunal</option> -->
                                                                        <option value="TRI" <?php
                                                                                if (isset($_REQUEST['court']) && ($_REQUEST['court'] == "TRI")) {
                                                                                    echo "selected=selected";
                                                                                }
                                                                                ?>data-dbsuffix="0">CESTAT Cases</option>
                                                                        <option value="AAR" <?php
                                                                                if (isset($_REQUEST['court']) && ($_REQUEST['court'] == "AAR")) {
                                                                                    echo "selected=selected";
                                                                                }
                                                                                ?>data-dbsuffix="0">AAR</option>
                                                                        <option value="NAA" <?php
                                                                                if (isset($_REQUEST['court']) && ($_REQUEST['court'] == "NAA")) {
                                                                                    echo "selected=selected";
                                                                                }
                                                                                ?>data-dbsuffix="0">NAA</option>
                                                                        <option value="AAAR" <?php
                                                                                if (isset($_REQUEST['court']) && ($_REQUEST['court'] == "AAAR")) {
                                                                                    echo "selected=selected";
                                                                                }
                                                                                ?>data-dbsuffix="0">AAAR</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-md-9 col-xs-16">
                                                                <div class="form-group">
                                                                    <select id='courtCityHC' name='courtCity' class="form-control" >
                                                                        ...
                                                                        <option value="ALH" <?php
                                                                        if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'ALH')) {
                                                                            echo "selected=selected";
                                                                        }
                                                                        ?>>Allahabad
                                                                        </option>
                                                                        <option value="AP" <?php
                                                                        if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'AP')) {
                                                                            echo "selected=selected";
                                                                        }
                                                                        ?>>Andhra Pradesh</option>
                                                                        <option value="GAU" <?php
                                                                        if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'GAU')) {
                                                                            echo "selected=selected";
                                                                        }
                                                                        ?>>Gauhati
                                                                        </option>
                                                                        <option value="CHG" <?php
                                                                        if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'CHG')) {
                                                                            echo "selected=selected";
                                                                        }
                                                                        ?>>Chhattishgarh
                                                                        </option>
                                                                        <option value="DEL" <?php
                                                                        if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'DEL')) {
                                                                            echo "selected=selected";
                                                                        }
                                                                        ?>>Delhi
                                                                        </option>
                                                                        <option value="BOM" <?php
                                                                                if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'BOM')) {
                                                                                    echo "selected=selected";
                                                                                }
                                                                                ?>>Bombay
                                                                        </option>
                                                                        <option value="GUJ" <?php
                                                                                    if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'GUJ')) {
                                                                                        echo "selected=selected";
                                                                                    }
                                                                                    ?>>Gujarat
                                                                        </option>
                                                                        <option value="P_H" <?php
                                                                                    if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'P_H')) {
                                                                                        echo "selected=selected";
                                                                                    }
                                                                                    ?>>Punjab & Haryana</option>
                                                                        <option value="J_K" <?php
                                                                                   if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'J_K')) {
                                                                                       echo "selected=selected";
                                                                                   }
                                                                                   ?>>Jammu & Kashmir</option>
                                                                        <option value="JHR" <?php
                                                                                   if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'JHR')) {
                                                                                       echo "selected=selected";
                                                                                   }
                                                                                   ?>>Jharkhand
                                                                        </option>
                                                                        <option value="KER" <?php
                                                                                   if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'KER')) {
                                                                                       echo "selected=selected";
                                                                                   }
                                                                                   ?>>Kerala
                                                                        </option>
                                                                        <option value="KAR" <?php
                                                                                   if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'KAR')) {
                                                                                       echo "selected=selected";
                                                                                   }
                                                                                   ?>>Karnataka
                                                                        </option>
                                                                        <option value="RAJ" <?php
                                                                                   if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'RAJ')) {
                                                                                       echo "selected=selected";
                                                                                   }
                                                                                   ?>>Rajasthan
                                                                        </option>
                                                                        <option value="ORI" <?php
                                                        if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'ORI')) {
                                                            echo "selected=selected";
                                                        }
                                                        ?>>Odisha
                                                                        </option>
                                                                        <option value="MAD" <?php
                                                        if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'MAD')) {
                                                            echo "selected=selected";
                                                        }
                                                        ?>>Madras
                                                                        </option>
                                                                        <option value="UTR" <?php
                                                        if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'UTR')) {
                                                            echo "selected=selected";
                                                        }
                                                                                   ?>>Uttarakhand
                                                                        </option>
                                                                        <option value="CAL" <?php
                                                               if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'CAL')) {
                                                                   echo "selected=selected";
                                                               }
                                                               ?>>Calcutta
                                                                        </option>
                                                                        <option value="MP" <?php
                                                                           if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'MP')) {
                                                                               echo "selected=selected";
                                                                           }
                                                                           ?>>Madhya Pradesh
                                                                        </option>
                                                                        <option value="SIK" <?php
                                                                           if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'SIK')) {
                                                                               echo "selected=selected";
                                                                           }
                                                                           ?>>Sikkim
                                                                        </option>
                                                                        <option value="MEG" <?php
                                                                           if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'MEG')) {
                                                                               echo "selected=selected";
                                                                           }
                                                                           ?>>Meghalaya
                                                                        </option>
                                                                        <option value="HP" <?php
                                                                           if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'HP')) {
                                                                               echo "selected=selected";
                                                                           }
                                                                           ?>>Himachal Pradesh
                                                                        </option>
                                                                        <option value="PAT" <?php
                            if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'PAT')) {
                                echo "selected=selected";
                            }
                            ?>>Patna
                                                                        </option>
            ...
            if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'TEL')) {
                echo "selected=selected";
            }
                    ?>>Telangana
                                                                        </option>
                                                                        <option value="TRI" <?php
            if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'TRI')) {
                echo "selected=selected";
            }
            ?>>Tripura
                                                                        </option>
                                                            ...
                                                            <div class="col-md-9 col-xs-16">
                                                                <div class="form-group">
                                                                    <select id='courtCityTRI' name='courtCity1' onchange="" class="form-control" >
                                                                        <option value="0">Select City</option>
                                                                        <option value="AHM" <?php
            if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'AHM')) {
                echo "selected=selected";
            }
            ?>>Ahmedabad
                                                                        </option>
            ...
            ?>>Allahabad
                                                                        ...
                                                                        <option value="BLR" <?php
            if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'BLR')) {
                echo "selected=selected";
            }
            ?>>Bangalore
                                                                        </option>
                                                                        <option value="CHD" <?php
            if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'CHD')) {
                echo "selected=selected";
            }
            ?>>Chandigarh
                                                                        </option>
                                                                        <option value="CHE" <?php
            if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'CHE')) {
                echo "selected=selected";
            }
            ?>>Chennai
                                                                        </option>
            ...
            ?>>Delhi
                                                                        ...
                                                                        <option value="HYD" <?php
            if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'HYD')) {
                echo "selected=selected";
            }
            ?>>Hyderabad
                                                                        </option>
                                                                        <option value="KOL" <?php
            if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'KOL')) {
                echo "selected=selected";
            }
            ?>>Kolkata
                                                                        </option>
                                                                        <option value="MUM" <?php
            if (isset($_REQUEST['courtCity']) && ($_REQUEST['courtCity'] == 'MUM')) {
                echo "selected=selected";
            }
            ?>>Mumbai
                                                                        </option>
            ...
            ?>
                                                                    ...
                                                                    <div class="col-md-2  col-xs-4">
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control" id="vol" placeholder="Volumn" name="vol" value="<?php
            if (isset($_REQUEST['vol']) && (!empty($_REQUEST['vol']))) {
                echo $_REQUEST['vol'];
            }
            ?>" onkeypress="return isNumberKey(event)"/>
                                                                        </div>
                                                                    ...
                                                                    <div class="col-md-3  col-xs-4">
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control" id="Citation" placeholder="" name="Citation" value="<?php
            if (isset($_REQUEST['Citation']) && (!empty($_REQUEST['Citation']))) {
                echo $_REQUEST['Citation'];
            }
            ?>" />
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            <div class="col-md-6 col-xs-16 text-center">
                                                                <label id="searchTypeLabel">Date</label>
                                                            </div>
                                                            <div class="col-md-10 col-xs-16">
                                                                <div class="form-group">
                                                                    <input type="date" class="form-control" id="date" placeholder="" name="date" value="<?php
            if (isset($_REQUEST['date']) && (!empty($_REQUEST['date']))) {
                echo $_REQUEST['date'];
            }
            ?>" />
