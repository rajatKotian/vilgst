...
//                echo $sql;
    ...
    if ($_REQUEST['pagename'] == 'Notification') {
        ...
        function notification() {
            $conditions = array();
            $conditions[] = "a.active_flag = 'Y'";
            $orderby = "order by a.circular_date DESC ";
...
//            $orderby = " ORDER BY substring_index (`circular_no`,'-',3) DESC";
            ...
            if ($_REQUEST['cgst_section'] != "" || $_REQUEST['cgst_section1'] != "" || $_REQUEST['cgst_section2'] != "") {
                if ($_REQUEST['cgst_section'] != "") {
                    $sec_no = trim(mysqli_real_escape_string($GLOBALS['con'],$_REQUEST['cgst_section']));
                } else {
                    $sec_no = "";
                }

                if ($_REQUEST['cgst_section1'] != "") {
                    $sec_no1 = "(" . trim(mysqli_real_escape_string($GLOBALS['con'],$_REQUEST['cgst_section1'])) . ")";
                } else {
                    $sec_no1 = "";
                }
                if ($_REQUEST['cgst_section2'] != "") {
                    $sec_alf = "(" . trim(mysqli_real_escape_string($GLOBALS['con'],$_REQUEST['cgst_section2'])) . ")";
                } else {
                    $sec_alf = "";
                }
                ...
                if ($_REQUEST['prod_id'] == "0" || $_REQUEST['prod_id'] == "7") {
                    ...
                    if ($_REQUEST['exact_search'] == 'exact') {
                        ...
                        //$conditions[] = "(a.section_no LIKE '$cgst_section' OR a.section_no LIKE '%,$cgst_section,%' OR a.section_no LIKE '%,$cgst_section%' OR a.section_no LIKE '%$cgst_section,%' OR a.section_no LIKE '%$cgst_section%')";
                    }
                    // $conditions[] = "(a.section_no LIKE '$cgst_section' OR a.section_no LIKE '%,$cgst_section,%' OR a.section_no LIKE '%,$cgst_section%' OR a.section_no LIKE '%$cgst_section,%' OR a.section_no LIKE '%$cgst_section%')";
                }
            }
            ...
            if ($_REQUEST['cgst_rule'] != "" || $_REQUEST['cgst_rule1'] != "" || $_REQUEST['cgst_rule2'] != "") {
                if ($_REQUEST['cgst_rule'] != "") {
                    $rule_no = trim(mysqli_real_escape_string($GLOBALS['con'],$_REQUEST['cgst_rule']));
                } else {
                    $rule_no = "";
                }

                if ($_REQUEST['cgst_rule1'] != "") {
                    $rule_no1 = "(" . trim(mysqli_real_escape_string($GLOBALS['con'],$_REQUEST['cgst_rule1'])) . ")";
                } else {
                    $rule_no1 = "";
                }
                if ($_REQUEST['cgst_rule2'] != "") {
                    $rule_alf = "(" . trim(mysqli_real_escape_string($GLOBALS['con'],$_REQUEST['cgst_rule2'])) . ")";
                } else {
                    $rule_alf = "";
                }
                ...
                if ($_REQUEST['prod_id'] == "0" || $_REQUEST['prod_id'] == "7") {
                    ...
                    if ($_REQUEST['exact_search'] == 'exact') {
                        ...
                        //$conditions[] = "(a.rule_no LIKE '$cgst_rule' OR a.rule_no LIKE '%,$cgst_rule,%' OR a.rule_no LIKE '%,$cgst_rule%' OR a.rule_no LIKE '%$cgst_rule,%' OR a.rule_no LIKE '%$cgst_rule%')";
                    }
            ...
            if ($_REQUEST['igst_section'] != "" || $_REQUEST['igst_section1'] != "" || $_REQUEST['igst_section2'] != "") {
                if ($_REQUEST['igst_section'] != "") {
                    $sec_no = trim(mysqli_real_escape_string($GLOBALS['con'],$_REQUEST['igst_section']));
                } else {
                    $sec_no = "";
                }

                if ($_REQUEST['igst_section1'] != "") {
                    $sec_no1 = "(" . trim(mysqli_real_escape_string($GLOBALS['con'],$_REQUEST['igst_section1'])) . ")";
                } else {
                    $sec_no1 = "";
                }
                if ($_REQUEST['igst_section2'] != "") {
                    $sec_alf = "(" . trim(mysqli_real_escape_string($GLOBALS['con'],$_REQUEST['igst_section2'])) . ")";
                } else {
                    $sec_alf = "";
                }
                ...
                if ($_REQUEST['prod_id'] == "0" || $_REQUEST['prod_id'] == "7") {
                    ...
                    // $conditions[] = "(a.igst_section_no LIKE '$igst_section' OR a.igst_section_no LIKE '%,$igst_section,%' OR a.igst_section_no LIKE '%,$igst_section%' OR a.igst_section_no LIKE '%$igst_section,%' OR a.igst_section_no LIKE '%$igst_section%')";
                }
            }
            ...
            if ($_REQUEST['igst_rule'] != "" || $_REQUEST['igst_rule1'] != "" || $_REQUEST['igst_rule2'] != "") {
                if ($_REQUEST['igst_rule'] != "") {
                    $rule_no = trim(mysqli_real_escape_string($GLOBALS['con'],$_REQUEST['igst_rule']));
                } else {
                    $rule_no = "";
                }

                if ($_REQUEST['igst_rule1'] != "") {
                    $rule_no1 = "(" . trim(mysqli_real_escape_string($GLOBALS['con'],$_REQUEST['igst_rule1'])) . ")";
                } else {
                    $rule_no1 = "";
                }
                if ($_REQUEST['igst_rule2'] != "") {
                    $rule_alf = "(" . trim(mysqli_real_escape_string($GLOBALS['con'],$_REQUEST['igst_rule2'])) . ")";
                } else {
                    $rule_alf = "";
                }
                ...
                if ($_REQUEST['prod_id'] == "0" || $_REQUEST['prod_id'] == "7") {
                    ...
                    // $conditions[] = "(a.igst_rule_no LIKE '$igst_rule' OR a.igst_rule_no LIKE '%,$igst_rule,%' OR a.igst_rule_no LIKE '%,$igst_rule%' OR a.igst_rule_no LIKE '%$igst_rule,%' OR a.igst_rule_no LIKE '%$igst_rule%')";
                }
            }
            ...
            // for category
            if ($_REQUEST['prod_id'] != 0) {
//                echo "SELECT p.prod_id,p.dbsuffix,sp.sub_prod_id FROM product as p LEFT JOIN sub_product as sp ON p.prod_id=sp.prod_id WHERE p.prod_id= '" . $_REQUEST['prod_id'] . "' AND (sp.sub_prod_type LIKE 'Judgements')" . $courtType;die;
...
//                                    echo "11111111111111asdasdasdsadsa";die;
                }
                if (!empty($sub_prod)) {
                    if (!empty($conditions)) {
                        $where_subprod = " AND (" . implode(' OR ', $sub_prod) . ")";
...
<div class="col-md-11 col-sm-9 left-section main_div">
    <h1><?php if (isset($_REQUEST['searchButton'])) {
    ...
    echo 'Advance Search';
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?php if (isset($_REQUEST['searchButton'])) {
    echo $_REQUEST['pagename'] . ' - Advance Search';
} else {
    echo 'Advance Search';
} ?></li>
...
function getNewPageUrl($queryParam, $paramValue){
    ...
    //building url = 
    $newUrl = $getBaseUrl . "/adv_search.php?";
                ...
                for ($i = 1; $i <= 10; $i++) {
                    ...
                    if ($c_page <= $lastPage) {
                        ...
                        ?>
                                ...
                                <!-- <li class="page-item">
                                        <a class="page-link" href="?q=<?php echo getNewPageUrl('page',$currentPage); ?>" tabindex="-1" aria-label="Previous">
                                                <span aria-hidden="true">Previous</span>
                                        </a>		
                                </li> -->
                        <?php
            ...
            success: function(html) {
                ...
                if (html != "") {
                    ...
                    if (fun_name == "Notification") {
                        var prod_id = "<?php if (isset($_REQUEST['prod_id'])) {
                    ...
                    echo "";
                        ...
                        if (prod_id != '' && prod_id != '0')
                        {
                            ...
                            var sub_product_id = "<?php if (isset($_REQUEST['sub_product_id'])) {
                    echo $_REQUEST['sub_product_id'];
                } else {
                    echo "";
                } ?>";
                            var type = "<?php if (isset($_REQUEST['type'])) {
                    echo $_REQUEST['type'];
                } else {
                    echo "";
                } ?>";
                    ...
                    echo "";
                        ...
                        var court = "<?php if (isset($_REQUEST['court'])) {
                    echo $_REQUEST['court'];
                } else {
                    echo "";
                } ?>"
