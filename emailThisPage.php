...
if(isset($_POST['emailPageYourName'])) {			
	...
	if($file_extn == 'pdf') { 
		...
		$vatinfolineLogo = "<div style='text-align: center;'><a href='http://vilgst.local' target='_blank'><img width='250' src='http://vilgst.local/images/vatinfoline-logo.png' border='0' /></a></div>";
		$copyrightText = "<div style='font-family:verdana,serif; font-size: 12px; border: 1px solid #ddd; background-color: #f5f5f5; padding: 10px; text-align: center; margin: 20px;'>This file is downloaded from <a style='color:#004e84;' href='http://vilgst.local' target='_blank'>www.vilgst.com</a> on <em>$timeStamp</em></div>";
...
//Carbon Copy
	$toCC = "support@vilgst.com";
	//$toCC = "anup.salpe@gmail.com";
	$subjectCC = "Page shared to ".$emailPageRecEmailID;

	$messageCC= "<a href='http://vilgst.local/shared/".$my_file."' target='_blank'>This Page</a>  has been shared to " . $emailPageRecEmailID .   " by " . $emailPageYourName ." from ".$emailPageCompName; 
	...
	$my_subject = "Page shared from VILGST !";
	...
	$message     = "<html>
				...
				<body>
					<table width='80%' cellspacing='5' cellpadding='10' border='0' style='font-family: Verdana,sans-serif;font-size:13px;color:#343c3f;background-color:#fff;border-collapse:collapse;border:2px solid #ff7808'>
						<tr>
						<td style='padding-left: 10px'>Hi, <br><br>" . $emailPageYourName ." has shared a Page from VILGST Portal for your perusal. Please find attached.<br><br>
						Thanks.<br><br>
