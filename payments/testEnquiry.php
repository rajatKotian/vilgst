...
if(isset($_POST['submit']))
{
	...
	if($response->get_resp_code() == 200 && is_a($response, 'EnquiryCollection')) 
	{
		...
		$html .= "<div class=\"tbl-col col-10\">Original Amount</div>";
		$html .= "<div class=\"tbl-col col-10\">Adjustment</div>";
		$html .= "<div class=\"tbl-col col-10\">Rule Id/Code</div>";
		$html .= "<div class=\"tbl-col col-10\">Offer Type</div>";
		$html .= "<div class=\"tbl-col col-10\">Transaction Amount</div>";
		$html .= "</div>";
		$html .= "</li>";
			...
			$html .= "<li style=\"width: 2200px;\">";
				$html .= "<div style=\"width: 2200px;\">";
					...
					if($enqObj->get_txn_type() == 'SALE'){
						$html .= "<div class=\"tbl-col col-10\">".$enqObj->get_total_refund_amount()."</div>";
					}else{
						$html .= "<div class=\"tbl-col col-10\">N/A</div>";
					}
					$html .= "<div class=\"tbl-col col-10\">".$enqObj->get_original_amount()." INR </div>";
					$html .= "<div class=\"tbl-col col-10\">".$enqObj->get_adjustment()." INR </div>";
					$html .= "<div class=\"tbl-col col-10\">".$enqObj->get_rule_name()."</div>";
					$html .= "<div class=\"tbl-col col-10\">".$enqObj->get_offer_type()."</div>";
					
					$html .= "<div class=\"tbl-col col-10\">".$enqObj->get_transaction_amount()."</div>";
				$html .= "</div>";
			$html .= "</li>";
		}
		$html .= "</ul>";
					...
					<ul class="form-wrapper add-merchant clearfix">
						<form action="testEnquiry.php" method="POST"
							...
							<li class="clearfix"><label width="125px;"> Merchant Access Key:</label><input
								name="merchantAccessKey" class="text" type="text" value="O5WI17U0LQNOI9DHIJAU" />
							</li>
