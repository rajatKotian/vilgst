...
if(isset($_POST['submit']))
{
	...
	if($response->get_resp_code() == 200)
	{
		...
		for($i=0;$i < count($ts);++$i)
		{
			...
			$html .= "<div class=\"tbl-col col-10\">".$tsObj->get_original_amount()."</div>";
			$html .= "<div class=\"tbl-col col-10\">".$tsObj->get_adjustment()."</div>";
			$html .= "<div class=\"tbl-col col-10\">".$tsObj->get_rule_name()."</div>";
			$html .= "<div class=\"tbl-col col-10\">".$tsObj->get_offer_type()."</div>";
			$html .= "<div class=\"tbl-col col-10\">".$tsObj->get_transaction_amount()."</div>";
			$html .= "</li>";
		}
		$html .= "</ul>";
		$html .= "</div>";
				...
				<div>
					<ul class="form-wrapper add-merchant clearfix">
						...
						<form action="testTS.php" method="POST" name="TransactionForm">
							...
							<p>(End Date should be withing 1 month from Start Date)</p>
