...
<style type="text/css">
    ...
    .input--style-1 { font-size: 12px; padding: 10px 0; color: #666; font-family: inherit; }
    .form-control { height: 30px !important; background: #fff; color: #000; font-size: 13px; border-radius: 4px;
        -webkit-box-shadow: none !important; box-shadow: none !important; border: transparent; }
    .widget-box h4 span { color: #696c70; font-size: 14px; float: right; text-transform: capitalize; }
    #sidebar .custom-menu {display: inline-block;position: absolute;top: 0px;left: 0px;-webkit-transition: 0.3s;
    ...
    .mail-input input { height: 55px; width: 100%; outline: none; border: none; border-radius: 5px; padding: 0 60px 0 20px;
...
<div class="wrapper d-flex align-items-stretch contain">
    <nav id="sidebar" class="order-last" class="img" style="background-image: url(images/bg_1.jpg);">
        <div class="custom-menu">
            ...
            <div>
                <div style="border-bottom: 1px solid #ff7808; text-align: center; font-size: 17px; margin-bottom: 15px; margin-top: 5px; background-color: #f527fc;">
