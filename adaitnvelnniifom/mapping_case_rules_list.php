<?php
$dataType = '';
$pageType = 'ListMappingCaseRules';
$pageHead = '';

include('header.php');
$addText = 'Mapping Case Rules';
            ...
            <div class="box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="box-tools pull-right" style="margin-left:10px;">
                                <a href="add_mapping_case_rules.php">Add Mapping Case Rules</a>     
                            </div>
                        </div>
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body" id="dataresult-container" style="padding-top: 50px;">
                    <table id="dataResult" class="display table table-bordered table-hover table-blue" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <?php
                            $mapping_case_rules = MappingCaseRulelist();
                            //getting list of all Mapping
                            if (count($mapping_case_rules) > 0) {
                                foreach ($mapping_case_rules as $rules) {
                                    ?>
                                    <tr>
                                        <td><p><?php echo $rules['id']; ?></p></td>
                                        <td><p><?php echo $rules['case_id']; ?></p></td>
                                        <td><p><?php echo $rules['case_type']; ?></p></td>
                                        <td><p><?php echo $rules['rule_id']; ?></p></td>
                                        <td><p><?php echo $rules['rule_type']; ?></p></td>
                                        <td>
                                            <p>
                                                <a href='edit_mapping_case_rules.php?id=<?php echo $rules['id']; ?>' data-id='' data-table='' data-toggle='tooltip' 
                                                   class='btn btn-success update-data' title='Edit Data'><i class='fa fa-edit'></i>
                                                </a>  
                                                <a href='#' data-id='<?php echo $rules['id']; ?>' data-table='mapping' data-toggle='tooltip' class='btn btn-danger delete-data' 
...
//        viewDataTableCustom();
        $('#dataResult').dataTable({
            ...
            "drawCallback": function() {
                ...
                loadPopupModalDeleteAll('mapping_case_rules', 'delete');
            },
