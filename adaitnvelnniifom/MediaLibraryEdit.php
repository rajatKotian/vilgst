<?php
$dataType = 'EditMediaLibrary';
$pageType = 'MediaLibraryEdit';
$pageHead = '';

include('header.php');
$addText = ' - Media Library';

if (isset($_GET['id'])) {
    //get Media Library detail by id
    $id = cleanForDB($_GET['id']);
    $media_data = getMediaLibrarybyId($_GET['id']);
}
$media_id = 0;
if (count($media_data) > 0 && $media_data['media_id'] == $id) {
    $validId = true;
    $media_id = $id;
} else {
    $validId = false;
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <input type="hidden" id="media_id" value="<?php echo "$media_id"; ?>" />
        ...
        <section class="content">
            <div class="alert alert-error alert-dismissable">
                ...
                <div><i class="icon fa fa-warning"></i><span>Invalid Media id</span> </div>
            </div>
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="mediaLibrary.php">List <?php echo "$pageHead"; ?> Media Library</a> &nbsp; &nbsp;             
                    </div>
                </div> 
...
<script type="text/javascript">
    $(document).ready(function() {
        if ($('#media_id').val() != 0) {
            loadEditFormCOI('media_library', $('#media_id').val());
        }else{
            $('.alert-error').show();
        }
    });
