<?php
$dataType = 'EditSectionChapter';
$pageType = 'COISectionEditChapter';
$pageHead = '';

include('header.php');
$addText = ' - COI Section Chapter';
//$chapter_id = $_GET['id'];

if (isset($_GET['id'])) {
    //get chapter detail by id
    $id = cleanForDB($_GET['id']);
    $chapter_data = getCOISectionChapterbyId($_GET['id']);
}
$chapter_id = 0;
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="COI_Section_ChapterList.php">List <?php echo "$pageHead"; ?> Chapters</a> &nbsp; &nbsp;             
                    </div>
                </div> 
...
<script type="text/javascript">
    $(document).ready(function() {
        if ($('#chapter_id').val() != 0) {
            loadEditFormCOI('coi_section_chapter', $('#chapter_id').val());
        }else{
            $('.alert-error').show();
        }
    });
