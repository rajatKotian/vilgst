<?php
$dataType = 'editGSTCouncilMeetingChapter';
$pageType = 'GSTCouncilMeetingEditChapter';
$pageHead = '';

include('header.php');
$addText = ' - GST Council Meeting Chapter';
//$chapter_id = $_GET['id'];

if (isset($_GET['id'])) {
    //get chapter detail by id
    $id = cleanForDB($_GET['id']);
    $chapter_data = getGSTCouncilMeetingChapterbyId($_GET['id']);
}
$chapter_id = 0;
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="gst_council_meeting_chapter_list.php">List <?php echo "$pageHead"; ?>GST Council Meeting Chapters</a> &nbsp; &nbsp;             
                    </div>
                </div> 
...
<script type="text/javascript">
    $(document).ready(function() {
        if ($('#chapter_id').val() != 0) {
            loadEditFormCOI('gst_council_meeting_chapter', $('#chapter_id').val());
        }else{
            $('.alert-error').show();
        }
    });
