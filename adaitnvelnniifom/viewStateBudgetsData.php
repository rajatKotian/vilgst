<?php 
  $pageType = 'viewStateBudgetsData';
  include('header.php'); 
  $pageHead = 'State Budget';
  $addText =  '';  
...
<!-- Content Wrapper. Contains page content -->
  ...
  <!-- Content Header (Page header) -->
    ...
    <div class="alert alert-success alert-dismissable">
      ...
      <div>  <i class="icon fa fa-check"></i> Data (State Budget id #<strong></strong>) <span>updated</span> successfully !</div>
    </div>   
    ...
    <!-- Default box -->
              ...
              <div class="row">
               <div class="col-md-9">
                  ...
                  <div class="box box-info">
                    <div class="box-header with-border">
                      <h3 class="box-title">Select State Budget Date Range</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
      ...
      <div class="box">
        <div class="box-header">
          ...
          <div class="box-tools pull-right">
            <a href="addStateBudgetsData.php">Add <?php echo "$pageHead"; ?></a>           
          </div>
        </div><!-- /.box-header -->
        <div class="box-body" id="dataresult-container" >
          ...
          <table id="dataResult" class="display table table-bordered table-hover" cellspacing="0" width="100%">
            <thead>
              <tr>
                <th style="min-width: 50px;">State Budget  ID</th>
...
var viewDataTableCustom = function(whereQuery) {
    ...
    var viewDataTable = $('#dataResult').dataTable({ 
      ...
      "ajax": "response/viewStateBudgetsData.php?"+whereQuery,
      "dom": '<"row"<"col-md-6"f><"col-md-6"i>>rt<"row"<"col-md-6"l><"col-md-6"p>><"clear">',
      "columns": [
              { "data": "id" },
              { "data": "date" },
              { "data": null, render: function ( data, type, row ) {
                  return "<a href='../showiframe?V1Zaa1VsQlJQVDA9="+data.encrypt_id+"&page=stateBudget' target='_blank'>"+data.subject+"</a>";
                  } 
              },   
              { "data": "summary" },
              { "data": null, render: function ( data, type, row ) {
      ...
      "drawCallback" : function () {
        loadPopupModalUpdateDelete('stateBudget','update');
        loadPopupModalUpdateDelete('stateBudget','delete');   
        initHtmlEditPage();
      },            
