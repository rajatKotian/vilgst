...
<!-- Content Wrapper. Contains page content -->
  ...
  <!-- Content Header (Page header) -->
    ...
    <div class="alert alert-success alert-dismissable">
      ...
      <div>  <i class="icon fa fa-check"></i> Data (Announcement id #<strong></strong>) <span>updated</span> successfully !</div>
    </div>   
    ...
    <!-- Default box -->
              ...
              <div class="row">
                <div class="col-md-9">
                  ...
                  <div class="box box-info">
                    <div class="box-header with-border">
                      <h3 class="box-title">Select Announcements Date Range</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
      ...
      <div class="box">
        <div class="box-header">
          ...
          <div class="box-tools pull-right">
            <a href="addAnnouncementData.php">Add <?php echo "$pageHead"; ?></a>           
          </div>
        </div><!-- /.box-header -->
...
var viewDataTableCustom = function(whereQuery) {
    var viewDataTable = $('#dataResult').dataTable({ 
      ...
      "ajax": "response/viewAnnouncementsData.php?"+whereQuery,
      ...
      "drawCallback" : function () {
        loadPopupModalUpdateDelete('marquee','update');
        loadPopupModalUpdateDelete('marquee','delete');   
        initHtmlEditPage();
      },            
