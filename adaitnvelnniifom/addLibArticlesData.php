<?php 
  $pageType = 'addLibArticles';
  include('header.php'); 
  $pageHead = 'Add Article in Library';
  $addText =  '';  
  ...
  <!-- Content Header (Page header) -->
    ...
    <section class="content">
      ...
      <div class="alert alert-success alert-dismissable">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
        <div>  <i class="icon fa fa-check"></i> Article in Library data added successfully !</div>
      </div>
        ...
        <div class="box-header with-border">
         <h3 class="box-title"><?php echo "$pageHead"; ?></h3>
          <div class="box-tools pull-right">
            <a href="viewLibArticlesData.php">View Articles in Library</a> &nbsp; &nbsp;          
