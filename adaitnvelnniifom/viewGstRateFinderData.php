      ...
      <div class="box">
        ...
        <div class="box-header">
          ...
          <div class="box-tools pull-right">
            ...
            <a href="gstRateFinder.php?dataType=GstRateFinder">Add <?php echo "$pageHead"; ?></a>           
...
var viewDataTableCustom = function(whereQuery) {
  debugger;
    ...
    var viewDataTable = $('#dataResult').dataTable({ 
      ...
      "ajax": "response/viewGstRateFinder.php?"+whereQuery,
      ...
      "drawCallback" : function () {
        ...
        loadPopupModalUpdateDelete('gstRateFinder','update');

        loadPopupModalUpdateDelete('gstRateFinder','delete');
