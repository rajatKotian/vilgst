            ...
            <div class="box">
                ...
                <div class="box-body" id="dataresult-container" style="padding-top: 50px;">
                    <table id="dataResult" class="display table table-bordered table-hover table-blue" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th style="width:10px; !important">Search ID</th>
                                <th style="width:10px; !important">User ID</th>
                                <th style="width:10px; !important">User Name</th>
                                <th>Keyword</th>
                                <th style="width:10px; !important">Party Name</th>
                                <th style="width:10px; !important">Topic</th>
                                <th style="width:10px; !important">Page Name</th>
                                <th style="width:10px; !important">Search IN</th>
                                <th style="width:10px; !important">Total Row Count</th>
                                <th>Updated Date</th>
                        ...
                        <tbody>
                            ...
                            //getting list of all Search History
                            if (count($Search_History) > 0) {
                                foreach ($Search_History as $Search) {
                                    ?>
                                    <tr>
                                        <td><p><?php echo $Search['search_id']; ?></p></td>
                                        <td><p><?php echo $Search['user_id']; ?></p></td>
                                        <td><p><?php echo $Search['user_name']; ?></p></td>
                                        <td><p><?php echo $Search['keyword']; ?></p></td>
                                        <td><p><?php echo $Search['party_name']; ?></p></td>
                                        <td><p><?php echo $Search['topic']; ?></p></td>
                                        <td><p><?php echo $Search['pagename']; ?></p></td>
                                        <td><p><?php echo $Search['search_in']; ?></p></td>
                                        <td><p><?php echo $Search['row_count']; ?></p></td>
                                        <td><p><?php echo $Search['updated_dt']; ?></p></td>
                                        <td>
                                            <p>
                                                <a href='edit_search_history.php?id=<?php echo $Search['search_id']; ?>' data-id='' data-table='search_history' data-toggle='tooltip' 
                                                   class='btn btn-success update-data' title='Edit Data'><i class='fa fa-edit'></i>
                                                </a>  
                                                <a href='#' data-id='<?php echo $Search['search_id']; ?>' data-table='search_history' data-toggle='tooltip' class='btn btn-danger delete-data' 
...
//        viewDataTableCustom();
        $('#dataResult').dataTable({
            ...
            "drawCallback": function() {
                ...
                loadPopupModalDeleteAll('search_history', 'delete');
            },
