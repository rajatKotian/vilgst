...
<!-- Content Wrapper. Contains page content -->
  ...
  <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>Add Recent Cases<small>it all starts here</small></h1>
      <ol class="breadcrumb">
    ...
    <!-- Default box -->
      <div class="box box-primary">
        ...
        <div class="box-body">
          <form role="form" class="form-horizontal" method="post" action="../addrecentauth.php" enctype="multipart/form-data"  onSubmit="return ValidateForm()">
