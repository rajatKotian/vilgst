<?php
$dataType = '';
$pageType = 'ListMappingCaseCites';
$pageHead = '';

include('header.php');
$addText = 'Mapping Case Cites';
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="box-tools pull-right" style="margin-left:10px;">
                                <a href="add_mapping_case_cites.php">Add Mapping Case Cites</a>     
                            </div>
                        </div>
                    </div>
                </div><!-- /.box-header -->
                    ...
                    <table id="dataResult" class="display table table-bordered table-hover table-blue" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>Case Type</th>
                                <th>Cited Case ID</th>
                                <th>Cited Case Type</th>
                                <th class="no-sort">Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            $mapping_case_cites = MappingCaseCitelist();
                            //getting list of all Mapping
                            if (count($mapping_case_cites) > 0) {
                                foreach ($mapping_case_cites as $cite) {
                                    ?>
                                    <tr>
                                        <td><p><?php echo $cite['id']; ?></p></td>
                                        <td><p><?php echo $cite['case_id']; ?></p></td>
                                        <td><p><?php echo $cite['case_type']; ?></p></td>
                                        <td><p><?php echo $cite['cited_case_id']; ?></p></td>
                                        <td><p><?php echo $cite['cited_case_type']; ?></p></td>
                                        <td>
                                            <p>
                                                <a href='edit_mapping_case_cites.php?id=<?php echo $cite['id']; ?>' data-id='' data-table='' data-toggle='tooltip' 
                                                   class='btn btn-success update-data' title='Edit Data'><i class='fa fa-edit'></i>
                                                </a>  
                                                <a href='#' data-id='<?php echo $cite['id']; ?>' data-table='mapping' data-toggle='tooltip' class='btn btn-danger delete-data' 
...
//        viewDataTableCustom();
        $('#dataResult').dataTable({
            ...
            "drawCallback": function() {
                ...
                loadPopupModalDeleteAll('mapping_case_cites', 'delete');
            },
