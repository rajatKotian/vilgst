...
$pageType = '';
include('header.php');
$pageHead = 'Edit GST Council Meeting HTML File';
$addText = '';
...
<div class="wrapper">
    ...
    if (isset($_POST['save-html'])) {
        ...
        if (file_put_contents("../data/GSTCouncilMeeting/$file_path", utf8_decode($data_to_write))) {
  ...
  <!-- Content Header  -->
    ...
    if (isset($_GET['V1Zaa1VsQlJQVDA9'])) {
        ...
        $result = mysqli_query($GLOBALS['con'],"SELECT * FROM gst_council_meeting where $primaryKey = '$decryptID'");
        ...
        while ($row = mysqli_fetch_array($result)) {
            $dirPath = "data/GSTCouncilMeeting/";
            $filePath = $dirPath . $row['meeting_file'];
            $file_path = str_replace(" ", "%20", "https://localhost/vilgst/" . $filePath);
                ...
                <section class="content">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo "GST Council Meeting" . " [<b>" . $row['meeting_name'] . " - #" . $row[$primaryKey] . "</b> ]"; ?></h3>
                        ...
                        <div class="box-body" >
                            ...
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" id="editHTML" name="editHTML" method="post" >
                                <input id="file_path" name="file_path" type="hidden" value="<?php echo $row['meeting_file']; ?>" />
