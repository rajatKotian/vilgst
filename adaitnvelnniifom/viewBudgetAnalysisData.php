<?php 
  $pageType = 'viewBudgetAnalysisData';
  include('header.php'); 
  $pageHead = 'Budget Analysis';
  $addText =  '';  
...
<!-- Content Wrapper. Contains page content -->
  ...
  <!-- Content Header (Page header) -->
    ...
    <div class="alert alert-success alert-dismissable">
      ...
      <div>  <i class="icon fa fa-check"></i> Data (Budget Analysis id #<strong></strong>) <span>updated</span> successfully !</div>
    </div>   
    ...
    <!-- Default box -->
              ...
              <div class="row">
               <div class="col-md-9">
                  ...
                  <div class="box box-info">
                    <div class="box-header with-border">
                      <h3 class="box-title">Select Budget Analysis Date Range</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
      ...
      <div class="box">
        <div class="box-header">
          ...
          <div class="box-tools pull-right">
            <a href="addBudgetAnalysisData.php">Add <?php echo "$pageHead"; ?></a>           
          </div>
        </div><!-- /.box-header -->
        <div class="box-body" id="dataresult-container" >
          ...
          <table id="dataResult" class="display table table-bordered table-hover" cellspacing="0" width="100%">
            <thead>
              <tr>
                <th style="min-width: 10px;">Budget Analysis  ID</th>
                <th style="min-width: 80px;">Budget Date</th>
                <th style="min-width: 150px;">Subject</th>
                <th>Summary</th>
                <th>Author</th>
                <th style="min-width: 50px;">New</th>
                <th style="min-width: 100px;">Actions</th>
              </tr>
            </thead>
            <tfoot>
              <tr>
                <th>Budget Analysis  ID</th>
                <th>Budget Date</th>
                <th>Subject</th>
                <th>Summary</th>
                <th>Author</th>
...
var viewDataTableCustom = function(whereQuery) {
    var viewDataTable = $('#dataResult').dataTable({ 
      ...
      "ajax": "response/viewBudgetAnalysisData.php?"+whereQuery,
      "dom": '<"row"<"col-md-6"f><"col-md-6"i>>rt<"row"<"col-md-6"l><"col-md-6"p>><"clear">',
      "columns": [
              { "data": "id" },
              { "data": "date" },
              { "data": null, render: function ( data, type, row ) {
                  return "<a  href='../showiframe?V1Zaa1VsQlJQVDA9="+data.encrypt_id+"&page=budgetAnalysis' target='_blank'>"+data.subject+"</a>";
                  } 
              },   
              { "data": "summary" },
              { "data": "author" },
      ...
      "drawCallback" : function () {
        loadPopupModalUpdateDelete('budgetAnalysis','update');
        loadPopupModalUpdateDelete('budgetAnalysis','delete'); 
        initHtmlEditPage();
      },            
