...
<!-- Content Wrapper. Contains page content -->
  ...
  <!-- Content Header (Page header) -->
    ...
    <div class="alert alert-success alert-dismissable">
      ...
      <div>  <i class="icon fa fa-check"></i> Data (Feature id #<strong></strong>) <span>updated</span> successfully !</div>
    </div>   
    ...
    <!-- Default box -->
      ...
      <div class="box">
        <div class="box-header">
          ...
          <div class="box-tools pull-right">
            <a href="addFeatureData.php">Add <?php echo "$pageHead"; ?></a>           
          </div>
        </div><!-- /.box-header -->
        <div class="box-body" id="dataresult-container" >
          ...
          <table id="dataResult" class="display table table-bordered table-hover" cellspacing="0" width="100%">
            <thead>
              <tr>
                <th style="min-width: 10px;">Features  ID</th>
                <th style="min-width: 80px;">Feature Date</th>
...
var viewDataTableCustom = function(whereQuery) {
    ...
    var viewDataTable = $('#dataResult').dataTable({ 
      ...
      "ajax": "response/viewFeaturesData.php?"+whereQuery,
      "dom": '<"row"<"col-md-6"f><"col-md-6"i>>rt<"row"<"col-md-6"l><"col-md-6"p>><"clear">',
      "columns": [
              { "data": "id" },
              { "data": "date" },
              { "data": null, render: function ( data, type, row ) {
                  return "<a  href='../showiframe?V1Zaa1VsQlJQVDA9="+data.encrypt_id+"&page=features' target='_blank'>"+data.subject+"</a>";
                  } 
              },   
              { "data": "summary" },
              { "data": "new_flag" },
      ...
      "drawCallback" : function () {
        loadPopupModalUpdateDelete('feature','update');
        loadPopupModalUpdateDelete('feature','delete');   
        initHtmlEditPage();
      },            
