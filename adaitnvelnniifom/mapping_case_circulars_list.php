<?php
$dataType = '';
$pageType = 'ListMappingCaseCirculars';
$pageHead = '';

include('header.php');
$addText = 'Mapping Case Circulars';
            ...
            <div class="box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="box-tools pull-right" style="margin-left:10px;">
                                <a href="add_mapping_case_circulars.php">Add Mapping Case Circulars</a>           
                            </div>
                        </div>
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body" id="dataresult-container" style="padding-top: 50px;">
                    <table id="dataResult" class="display table table-bordered table-hover table-blue" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <?php
                            $mapping_case_circulars = MappingCaseCircularlist();
                            //getting list of all Mapping
                            if (count($mapping_case_circulars) > 0) {
                                foreach ($mapping_case_circulars as $circular) {
                                    ?>
                                    <tr>
                                        <td><p><?php echo $circular['id']; ?></p></td>
                                        <td><p><?php echo $circular['case_id']; ?></p></td>
                                        <td><p><?php echo $circular['case_type']; ?></p></td>
                                        <td><p><?php echo $circular['circular_id']; ?></p></td>
                                        <td><p><?php echo $circular['circular_type']; ?></p></td>
                                        <td>
                                            <p>
                                                <a href='edit_mapping_case_circulars.php?id=<?php echo $circular['id']; ?>' data-id='' data-table='' data-toggle='tooltip' 
                                                   class='btn btn-success update-data' title='Edit Data'><i class='fa fa-edit'></i>
                                                </a>  
                                                <a href='#' data-id='<?php echo $circular['id']; ?>' data-table='mapping' data-toggle='tooltip' class='btn btn-danger delete-data' 
...
//        viewDataTableCustom();
        $('#dataResult').dataTable({
            ...
            "drawCallback": function() {
                ...
                loadPopupModalDeleteAll('mapping_case_circulars', 'delete');
            },
