        ...
        <div class="box-header" style="position: relative;">
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <div class="box-tools pull-right">
                <a href="addMultipleCaseData.php">Add Multiple Data</a>
              </div>
            </div>
          </div>
        </div><!-- /.box-header -->
...
<script type="text/javascript" language="javascript" class="init">
  ...
  $(document).ready(function() {
    ...
    $('#custom_search_container button').on('click', function() {
      ...
      if (prod_id != '') {
        viewDataTableCustom("prod_id=" + prod_id + "&party_name=" + searchKeywordPartyName);
      } else {
  ...
  var loadPopupModalUpdateDeleteAll = function(file, action) {
    ...
    $('.' + action + '-data').on('click', function(e) {
      ...
      $modal.load('modals/' + action + '/' + file + '.php?' + 'data=' + $(this).data('table'), {
          'id': $(this).data('id')
        },
