<?php 
  ...
  $pageType = 'addSearchCategory';

  include('header.php'); 

  $pageHead = 'Select Search Category';
  ...
  <!-- Content Header (Page header) -->
    ...
    <section class="content">
      ...
      <div class="alert alert-success alert-dismissable">
        ...
        <div>  <i class="icon fa fa-check"></i> Search Category data selected successfully !</div>
        ...
        <div class="box-header with-border">
         ...
         <h3 class="box-title"><?php echo "$pageHead"; ?></h3>
          ...
          <div class="box-tools pull-right">
            ...
            <a href="viewArticlesData.php">View Search Category</a> &nbsp; &nbsp;          
