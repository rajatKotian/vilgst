          ...
          <table id="dataResult" class="display table table-bordered table-hover" cellspacing="0" width="100%">
            ...
            <thead>
              ...
              <tr>
                ...
                <th style="min-width: 80px;">Short Form</th>

                <th style="min-width: 150px;">Full Form</th>
...
var viewDataTableCustom = function(whereQuery) {
  debugger;
    ...
    var viewDataTable = $('#dataResult').dataTable({ 
      ...
      "ajax": "response/viewShortFormData.php?"+whereQuery,
      ...
      "drawCallback" : function () {
        ...
        loadPopupModalUpdateDelete('short_form','update');

        loadPopupModalUpdateDelete('short_form','delete');
