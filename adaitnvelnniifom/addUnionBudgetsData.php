<?php 
  $dataType = '';
  $pageType = 'addUnionBudgetsData';
  $pageHead = 'Add Union Budget ';
...
<!-- Content Wrapper. Contains page content -->
  ...
  <!-- Content Header (Page header) -->
    ...
    <section class="content-header">
      <input type="hidden" id="dataType" value="unionBudget" />
    ...
    <section class="content">
      ...
      <div class="alert alert-success alert-dismissable">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
        <div>  <i class="icon fa fa-check"></i> Union Budget data added successfully !</div>
      </div>
        ...
        <div class="box-header with-border">
         <h3 class="box-title"><?php echo "$pageHead"; ?></h3>
          <div class="box-tools pull-right">
            <a href="viewUnionBudgetsData.php">View Union Budget</a> &nbsp; &nbsp;          
