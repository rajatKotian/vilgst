<?php
$dataType = '';
$pageType = 'ListMappingData';
$pageHead = '';

include('header.php');
$addText = 'Mapping Data';
?>
<style type="text/css">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="box-tools pull-right" style="margin-left:10px;">
                                <a href="add_mapping_data.php">Add Mapping Data</a>           
                            </div>
                        </div>
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body" id="dataresult-container" style="padding-top: 50px;">
                    <table id="dataResult" class="display table table-bordered table-hover table-blue" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th style="min-width: 5px;">Data ID</th>
                                <th style="min-width: 20px;">Data Type</th>
                                <th>Product Name</th>
                                <th style="min-width: 300px;">Sub Product Name</th>
                                <th class="no-sort">Reference ID</th>
                                <th style="min-width: 5px;">Reference Type</th>
                                <th style="min-width: 20px;">Reference Product Name</th>
                                <th>Reference Sub Product Name</th>
                                <th class="no-sort">Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            $mappings = mappingalldatalist();
                            //getting list of all Mapping
                            if (count($mappings) > 0) {
                                foreach ($mappings as $mapping) {
                                    ?>
                                    <tr>
                                        <td><p><?php echo $mapping['id']; ?></p></td>
                                        <td><p><?php echo $mapping['data_id']; ?></p></td>
                                        <td><p><?php echo $mapping['data_type']; ?></p></td>
                                        <td><p><?php echo $mapping['data_prod_name']; ?></p></td>
                                        <td><p><?php echo $mapping['data_sub_prod_name']; ?></p></td>
                                        <td><p><?php echo $mapping['reference_id']; ?></p></td>
                                        <td><p><?php echo $mapping['reference_type']; ?></p></td>
                                        <td><p><?php echo $mapping['reference_prod_name']; ?></p></td>
                                        <td><p><?php echo $mapping['reference_sub_prod_name']; ?></p></td>
                                        <td>
                                            <p>
                                                <a href='edit_mapping_data.php?id=<?php echo $mapping['id']; ?>' data-id='' data-table='' data-toggle='tooltip' 
                                                   class='btn btn-success update-data' title='Edit Data'><i class='fa fa-edit'></i>
                                                </a>  
                                                <a href='#' data-id='<?php echo $mapping['id']; ?>' data-table='mapping' data-toggle='tooltip' class='btn btn-danger delete-data' 
...
//        viewDataTableCustom();
        $('#dataResult').dataTable({
            ...
            "drawCallback": function() {
                ...
                loadPopupModalDeleteAll('mapping', 'delete');
            },
