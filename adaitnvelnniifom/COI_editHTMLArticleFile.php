...
<div class="wrapper">
    ...
    if (isset($_POST['save-html'])) {
       ...
       //$data_to_write = preg_replace('/\s+/', ' ', $data_to_write);
        if (file_put_contents("../data/COI/$file_path", utf8_decode($data_to_write))) {
  ...
  <!-- Content Header  -->
    ...
    if (isset($_GET['V1Zaa1VsQlJQVDA9'])) {
        ...
        $result = mysqli_query($GLOBALS['con'],"SELECT * FROM coi_articles where  $primaryKey = '$decryptID'");
        ...
        while ($row = mysqli_fetch_array($result)) {
            $dirPath = "/data/COI/";
            $filePath = $dirPath . $row['article_file'];
                ...
                <section class="content">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo "COI Article" . " [<b>" . $row['article_name'] . " - #" . $row[$primaryKey] . "</b> ]"; ?></h3>
                        ...
                        <div class="box-body" >
                            ...
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" id="editHTML" name="editHTML" method="post" >
                                <input id="file_path" name="file_path" type="hidden" value="<?php echo $row['article_file']; ?>" />
