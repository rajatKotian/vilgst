<?php
$dataType = '';
$pageType = 'GSTCouncilMeetingListChapter';
$pageHead = '';

include('header.php');
$addText = 'All GST Council Meeting Chapters';
?>
<style type="text/css">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="box-tools pull-right" style="margin-left:10px;">
                                <a href="add_gst_council_meeting_chapter.php">Add GST Council Meeting Chapters</a>           
                            </div>
                ...
                <div class="box-body" id="dataresult-container" style="padding-top: 50px;">
                    <table id="dataResult" class="display table table-bordered table-hover table-blue" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            $chapters = listGSTCouncilMeetingChapter();
                            if (count($chapters) > 0) {
                                foreach ($chapters as $chapter) {
                                    ...
                                    <tr>
                                        ...
                                        <td><p><?php echo $chapter['chapter_date']; ?></p></td>
                                        <td><p>
                                                <a href='edit_gst_council_meeting_chapter.php?id=<?php echo $chapter['id']; ?>' data-id='' data-table='' data-toggle='tooltip' 
                                                   class='btn btn-success update-data' title='Edit Data'><i class='fa fa-edit'></i>
                                                </a>  
                                                <a href='#' data-id='<?php echo $chapter['id']; ?>' data-table='gst_council_meeting_chapter' data-toggle='tooltip' class='btn btn-danger delete-data' 
                                                   title='Delete Data'><i class='fa fa-trash-o'></i>
                                                </a>
                                                <a href='gst_council_meeting_list.php?chapter_id=<?php echo $chapter['id']; ?>' data-id='<?php echo $chapter['id']; ?>' data-table='gst_council_meeting_chapter' data-toggle='tooltip' class='btn btn-success list-data' 
                                                   title='List GST Council Meeting'> <i class="fa fa-list" aria-hidden="true"></i>
                                                </a>
                                            </p></td>
                                    </tr>
                                    <?php
...
//        viewDataTableCustom();
        $('#dataResult').dataTable({
            ...
            "drawCallback": function() {
                ...
                loadPopupModalDeleteAll('gst_council_meeting_chapter', 'delete');
            },
