                             ...
                             if (count($menus) > 0) {
                                 foreach ($menus as $menu) {
                                    ...
                                    <tr>
                                        ...
                                        <td><p><?php echo $menu['menu_name']; ?></p></td>
                                        <td><p><?php echo $menu['url']; ?></p></td>
                                        <td><p><?php echo $menu['parent_id']; ?></p></td>
                                        <td>
                                            <p>
                                                <a href='edit_menu.php?id=<?php echo $menu['id']; ?>' data-id='' data-table='' data-toggle='tooltip' 
                                                   class='btn btn-success update-data' title='Edit Data'><i class='fa fa-edit'></i>
                                                </a>  
                                                <a href='#' data-id='<?php echo $menu['id']; ?>' data-table='mapping' data-toggle='tooltip' class='btn btn-danger delete-data' 
...
//        viewDataTableCustom();
        $('#dataResult').dataTable({
            ...
            "drawCallback": function() {
                ...
                loadPopupModalDeleteAll('menu', 'delete');
            },
