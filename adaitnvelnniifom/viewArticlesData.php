      ...
      <div class="box">
        ...
        <div class="box-header">
          ...
          <div class="box-tools pull-right">
            ...
            <a href="addArticleData.php">Add <?php echo "$pageHead"; ?></a>           
          ...
          <table id="dataResult" class="display table table-bordered table-hover" cellspacing="0" width="100%">
            ...
            <thead>
              ...
              <tr>
                ...
                <th style="min-width: 50px;">Cat</th>
...
var viewDataTableCustom = function(whereQuery) {
    ...
    var viewDataTable = $('#dataResult').dataTable({ 
      ...
      "ajax": "response/viewArticlesData.php?"+whereQuery,
      ...
      "columns": [
              ...
              { "data": null, render: function ( data, type, row ) {
                  ...
                  return "<a  href='../showiframe?V1Zaa1VsQlJQVDA9="+data.encrypt_id+"&page=articles' target='_blank'>"+data.subject+"</a>";
      ...
      "drawCallback" : function () {
        ...
        loadPopupModalUpdateDelete('article','update');

        loadPopupModalUpdateDelete('article','delete');
