<?php
$dataType = '';
$pageType = 'ListMappingCaseSections';
$pageHead = '';

include('header.php');
$addText = 'Mapping Case Sections';
            ...
            <div class="box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="box-tools pull-right" style="margin-left:10px;">
                                <a href="add_mapping_case_sections.php">Add Mapping Case Sections</a>     
                            </div>
                        </div>
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body" id="dataresult-container" style="padding-top: 50px;">
                    <table id="dataResult" class="display table table-bordered table-hover table-blue" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <?php
                            $mapping_case_sections = MappingCaseSectionlist();
                            //getting list of all Mapping
                            if (count($mapping_case_sections) > 0) {
                                foreach ($mapping_case_sections as $sections) {
                                    ?>
                                    <tr>
                                        <td><p><?php echo $sections['id']; ?></p></td>
                                        <td><p><?php echo $sections['case_id']; ?></p></td>
                                        <td><p><?php echo $sections['case_type']; ?></p></td>
                                        <td><p><?php echo $sections['section_id']; ?></p></td>
                                        <td><p><?php echo $sections['section_type']; ?></p></td>
                                        <td>
                                            <p>
                                                <a href='edit_mapping_case_sections.php?id=<?php echo $sections['id']; ?>' data-id='' data-table='' data-toggle='tooltip' 
                                                   class='btn btn-success update-data' title='Edit Data'><i class='fa fa-edit'></i>
                                                </a>  
                                                <a href='#' data-id='<?php echo $sections['id']; ?>' data-table='mapping' data-toggle='tooltip' class='btn btn-danger delete-data' 
...
//        viewDataTableCustom();
        $('#dataResult').dataTable({
            ...
            "drawCallback": function() {
                ...
                loadPopupModalDeleteAll('mapping_case_sections', 'delete');
            },
