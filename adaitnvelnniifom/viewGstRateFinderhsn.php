      ...
      <div class="box">
        ...
        <div class="box-header">
          ...
          <div class="box-tools pull-right">
            ...
            <a href="addGstRateFinder.php?dataType=hsn">Add <?php echo "$pageHead"; ?></a>           
...
var viewDataTableCustom = function(whereQuery) {
  debugger;
    ...
    var viewDataTable = $('#dataResult').dataTable({ 
      ...
      "ajax": "response/viewGstRateFinderhsn.php?"+whereQuery,
      ...
      "drawCallback" : function () {
        ...
        loadPopupModalUpdateDelete('gstRateFinderhsn','update');

        loadPopupModalUpdateDelete('gstRateFinderhsn','delete');
