<?php
$dataType = 'EditSection';
$pageType = 'COISectionEditSection';
$pageHead = '';
...
if (isset($_GET['id'])) {
    ...
    $section_data = getCOISectionbyId($_GET['id']);
}
$section_id = 0;
if (count($section_data) > 0 && $section_data['id'] == $id) {
    $validId = true;
    $section_id = $id;
} else {
    $validId = false;
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="COI_SectionList.php">List <?php echo "$pageHead"; ?> Sections</a> &nbsp; &nbsp;             
                    </div>
                </div> 
...
<script type="text/javascript">
    $(document).ready(function() {
        if ($('#section_id').val() != 0) {
            loadEditFormCOI('coi_section', $('#section_id').val());
        } else {
            $('.alert-error').show();
        }
    });
