...
function reload(form){
	...
	self.location='addrecent.php?product=' + val + '&sub_prod=' + sub_prod + '&state=' + state + '&cir_date=' + cir_date + '&cir_no=' + cir_no;
}
...
<div class="box box-primary">
	<div class="box-header with-border">
		<h3 class="box-title">Add Recent Cases</h3>
	</div><!-- /.box-header -->
	 <!-- form start -->
	<form role="form" method="post" action="../addrecentauth.php" enctype="multipart/form-data"  onSubmit="return ValidateForm()">
		<div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="box-footer">
                    <button type="submit" id="Submit" class="btn btn-primary">Add Recent Case</button>                    
                  </div>
            </form>            
 			</div> 
