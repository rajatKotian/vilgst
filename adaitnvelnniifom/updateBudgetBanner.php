<?php 
  $pageType = 'updateBudgetBanner';
  include('header.php'); 
  $pageHead = 'Budget Banner';
  $addText =  '';  
...
<!-- Content Wrapper. Contains page content -->
  ...
  <!-- Content Header (Page header) -->
    ...
    <section class="content-header">
      ...
      <h1><?php echo "$pageHead $addText"; ?> <small> Update <?php echo "$pageHead $addText"; ?> here</small></h1>
      <ol class="breadcrumb">
...
<script type="text/javascript">
  $(document).ready(function() {
    loadAddForm('updateBudgetBanner');
  });
</script>
