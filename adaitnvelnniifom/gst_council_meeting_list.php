<?php
$dataType = '';
$pageType = 'GSTCouncilMeetingList';
$pageHead = '';

include('header.php');
$addText = 'All GST Council Meeting';
$chapter_id = 0;
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="box-tools pull-right" style="margin-left:10px;">
                                <a href="add_gst_council_meeting_chapter.php">Add GST Council Meeting Chapter</a>           
                            </div>
                            <div class="box-tools pull-right">
                                <a href="add_gst_council_meeting.php">Add GST Council Meeting</a>           
                            </div>
                        </div>
                    </div>
                        ...
                        <table id="dataResult" class="display table table-bordered table-hover table-blue" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>Meeting No</th>
                                    <th style="min-width: 150px;">GST Council Meeting Name</th>
                                    <th>Chapter No</th>
                                    <th style="min-width: 50px;">GST Council Meeting File</th>
                            ...
                            <tbody>
                                ...
                                $meetings = listGSTCouncilMeeting($chapter_id);
                                if (count($meetings) > 0) {
                                    foreach ($meetings as $meeting) {
                                        ?>
                                        <tr>
                                            <td><p><?php echo $meeting['id']; ?></p></td>
                                            <td><p><?php echo $meeting['meeting_no']; ?></p></td>
                                            <td><p><?php echo $meeting['meeting_name']; ?></p></td>
                                            <td><p><?php echo "Chapter " . $meeting['chapter_no'];?></p></td>
                                            <td><p>
                                                    <?php
                                                    $encryptyId = base64_encode(base64_encode($meeting['id']));
                                                    $GSTCouncilMeetingNameDisplay = "Meeting " . $meeting['meeting_no'];
                                                    echo "<a  href='../showiframe4?V1Zaa1VsQlJQVDA9=" . $encryptyId . "&showGSTCouncilMeeting' target='_blank' >" . $GSTCouncilMeetingNameDisplay . "</a><button class='copy-file-link badge bg-navy'>Copy</button>";
                                                    ?>
                                                </p>
                                            </td>
                                            <td>
                                                <p>
                                                    <a href="GST_editHTMLCouncilMeetingFile.php?V1Zaa1VsQlJQVDA9=<?php echo $encryptyId; ?>&table=gst_council_meeting&primarykey=id&name=<?php echo $meeting['meeting_no']; ?>&title=<?php echo $meeting['meeting_name']; ?>" data-id="<?php echo $encryptyId ?>" data-table="gst_council_meeting" data-name="<?php echo $meeting['meeting_name']; ?>" data-title="GST Council Meeting" data-toggle="tooltip" class="btn btn-warning edit-html" title="" data-original-title="Edit HTML" target="_blank"><i class="fa fa-file-code-o"></i>
                                                    </a>
                                                    <a href='edit_gst_council_meeting.php?id=<?php echo $meeting['id']; ?>' data-id='<?php echo $meeting['id']; ?>' data-table='gst_council_meeting' data-toggle='tooltip' 
                                                       class='btn btn-success update-data' title='Edit Data'><i class='fa fa-edit'></i>
                                                    </a>  
                                                    <a href='#' data-id='<?php echo $meeting['id']; ?>' data-table='gst_council_meeting' data-toggle='tooltip' class='btn btn-danger delete-data' 
...
//        viewDataTableCustom();
        $('#dataResult').dataTable({
            ...
            "drawCallback": function() {
                loadPopupModalDeleteAll('gst_council_meeting', 'delete');
                copyLinkToClipboard();
//                initHtmlEditPage();
            },
