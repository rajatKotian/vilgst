        ...
        <div class="box-header with-border">
         <h3 class="box-title"><?php echo "$pageHead"; ?></h3>
          <div class="box-tools pull-right">
            <a href="viewGstRateFinder<?php echo $dataType;?>.php?dataType=<?php echo "$dataType"; ?>">View <?php echo "$pageHead"; ?> Data</a> &nbsp; &nbsp;             
...
<script type="text/javascript">
  $(document).ready(function() {
    var file='gstRateFinder'+$('#dataType').val();
    loadProductForm(file);
  });
</script>
