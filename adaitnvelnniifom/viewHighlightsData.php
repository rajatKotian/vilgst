...
<!-- Content Wrapper. Contains page content -->
  ...
  <!-- Content Header (Page header) -->
    ...
    <div class="alert alert-success alert-dismissable">
      ...
      <div>  <i class="icon fa fa-check"></i> Data (Highlights id #<strong></strong>) <span>updated</span> successfully !</div>
    </div>   
    ...
    <!-- Default box -->
              ...
              <div class="row">
               <div class="col-md-9">
                  ...
                  <div class="box box-info">
                    <div class="box-header with-border">
                      <h3 class="box-title">Select Highlights Date Range</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
      ...
      <div class="box">
        <div class="box-header">
          ...
          <div class="box-tools pull-right">
            <a href="addHighlightData.php">Add <?php echo "$pageHead"; ?></a>           
          </div>
        </div><!-- /.box-header -->
        <div class="box-body" id="dataresult-container" >
          ...
          <table id="dataResult" class="display table table-bordered table-hover" cellspacing="0" width="100%">
            <thead>
              <tr>
                <th style="min-width: 10px;">Highlight  ID</th>
                <th style="min-width: 80px;">Highlight Date</th>
...
var viewDataTableCustom = function(whereQuery) {
    var viewDataTable = $('#dataResult').dataTable({ 
      ...
      "ajax": "response/viewHighlightsData.php?"+whereQuery,
      "dom": '<"row"<"col-md-6"f><"col-md-6"i>>rt<"row"<"col-md-6"l><"col-md-6"p>><"clear">',
      "columns": [
              { "data": "id" },
              { "data": "date" },
              { "data": null, render: function ( data, type, row ) {
                  return "<a  href='../showiframe?V1Zaa1VsQlJQVDA9="+data.encrypt_id+"&page=highlights' target='_blank' >"+data.subject+"</a>";
                  } 
              },   
              { "data": "summary" },
              { "data": "new_flag" },
              { "data": null, render: function ( data, type, row ) {
                ...
                return "<a href='"+fileLink+"' "+setTarget+" data-id='"+data.encrypt_id+"' data-table='highlights' data-primarykey='highlight_id' data-name='subject' data-title='Highlights'  data-toggle='tooltip' class='btn btn-warning "+htmlClass+"' title='"+linkTitle+"'><i class='fa fa-file-"+linkIcon+"-o'></i></a>   <a href='#' data-id='"+data.id+"' data-toggle='tooltip' class='btn btn-success update-data' title='Edit Data'><i class='fa fa-edit'></i></a>     <a href='#' data-id='"+data.id+"' data-toggle='tooltip' class='btn btn-danger' title='Delete Data'><i class='fa fa-trash-o'></i></a>";
                } 
              }  
        ],
        "columnDefs": [
      ...
      "drawCallback" : function () {
        loadPopupModalUpdateDelete('highlight','update');
        loadPopupModalUpdateDelete('highlight','delete');
        initHtmlEditPage();
      },            
