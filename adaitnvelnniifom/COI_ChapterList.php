<?php
$dataType = '';
$pageType = 'COIArticleListChapter';
$pageHead = '';

include('header.php');
$addText = 'All COI Parts';
?>
<style type="text/css">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="box-tools pull-right" style="margin-left:10px;">
                                <a href="COI_ChapterAdd.php">Add Parts</a>           
                            </div>
                    ...
                    <table id="dataResult" class="display table table-bordered table-hover table-blue" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>Part No. (Display)</th>
                                <th style="min-width: 300px;">Part Name</th>
                            ...
                            if (count($chapters) > 0) {
                                foreach ($chapters as $chapter) {
                                    ...
                                    <tr>
                                        ...
                                        <td><p>
                                                <a href='COI_ChapterEdit.php?id=<?php echo $chapter['id']; ?>' data-id='' data-table='' data-toggle='tooltip' 
                                                   class='btn btn-success update-data' title='Edit Data'><i class='fa fa-edit'></i>
                                                </a>  
                                                <a href='#' data-id='<?php echo $chapter['id']; ?>' data-table='coi_chapter' data-toggle='tooltip' class='btn btn-danger delete-data' 
                                                   title='Delete Data'><i class='fa fa-trash-o'></i>
                                                </a>
                                                <a href='COI_ArticleList.php?chapter_id=<?php echo $chapter['id']; ?>' data-id='<?php echo $chapter['id']; ?>' data-table='coi_chapter' data-toggle='tooltip' class='btn btn-success list-data' 
                                                   title='List Articles'> <i class="fa fa-list" aria-hidden="true"></i>
                                                </a>
                                            </p></td>
                                    </tr>
                                    <?php
...
//        viewDataTableCustom();
        $('#dataResult').dataTable({
            ...
            "drawCallback": function() {
                ...
                loadPopupModalDeleteAll('coi_chapter', 'delete');
            },
