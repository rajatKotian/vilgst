      ...
      <div class="box">
        ...
        <div class="box-header">
          ...
          <div class="box-tools pull-right">
            ...
            <a href="addGstRateFinder.php?dataType=goods">Add <?php echo "$pageHead"; ?></a>           
...
var viewDataTableCustom = function(whereQuery) {
  debugger;
    ...
    var viewDataTable = $('#dataResult').dataTable({ 
      ...
      "ajax": "response/viewGstRateFindergoods.php?"+whereQuery,
      ...
      "drawCallback" : function () {
        ...
        loadPopupModalUpdateDelete('gstRateFindergoods','update');

        loadPopupModalUpdateDelete('gstRateFindergoods','delete');
