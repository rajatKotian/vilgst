<?php 
  $pageType = 'viewLibArticles';
  include('header.php'); 
  $pageHead = 'Articles in Library';
  $addText =  '';  
    ...
    <!-- Default box -->
      ...
      <div class="box">
        <div class="box-header">
          ...
          <div class="box-tools pull-right">
            <a href="addLibArticlesData.php">Add <?php echo "$pageHead"; ?></a>           
          </div>
        </div><!-- /.box-header -->
        <div class="box-body" id="dataresult-container" >
          ...
          <table id="dataResult" class="display table table-bordered table-hover" cellspacing="0" width="100%">
            <thead>
              <tr>
                <th style="min-width: 10px;">Article  ID</th>
                <th style="min-width: 100px;">Library Type</th>
                <th style="min-width: 80px;">Article Date</th>
                <th>Subject Hidden </th>
...
var viewDataTableCustom = function(whereQuery) {
    var viewDataTable = $('#dataResult').dataTable({ 
      ...
      "ajax": "response/viewLibArticlesData.php?"+whereQuery,
      ...
      "columns": [
              ...
              { "data": null, render: function ( data, type, row ) {
                  return "<a  href='../showiframe?V1Zaa1VsQlJQVDA9="+data.encrypt_id+"&page=libArticles' target='_blank' >"+data.subject+"</a>";
                  } 
              },   
              { "data": "summary" },
              { "data": "author" },
      ...
      "drawCallback" : function () {
        loadPopupModalUpdateDelete('libArticle','update');
        loadPopupModalUpdateDelete('libArticle','delete');    
        initHtmlEditPage();  
      },            
