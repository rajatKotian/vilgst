...
if (isset($_GET['start_date']) && isset($_GET['end_date'])) {
    ...
    if(isset($_GET['sub_prod_id']) && $_GET['sub_prod_id'] != '0') {
        ...
        $whereAll = ' (circular_date BETWEEN  "'.$_GET['start_date'].'" AND  "'.$_GET['end_date'].'")' . " AND sub_prod_id='".$_GET['sub_prod_id']."' AND " . $prod_id;

    } else {

        $whereAll = ' (circular_date BETWEEN  "'.$_GET['start_date'].'" AND  "'.$_GET['end_date'].'") AND ' . $prod_id;
    ...
    if($_GET['sub_prod_id'] != '0') {
        ...
        $whereAll = " sub_prod_id='".$_GET['sub_prod_id']."' AND " . $prod_id;
