...
<!-- Content Wrapper. Contains page content -->
  ...
  <!-- Content Header (Page header) -->
    ...
    <div class="alert alert-success alert-dismissable">
      ...
      <div>  <i class="icon fa fa-check"></i> Data (Schedule id #<strong></strong>) <span>updated</span> successfully !</div>
    </div>   
    ...
    <!-- Default box -->
              ...
              <div class="row">
               <div class="col-md-9">
                  ...
                  <div class="box box-info">
                    <div class="box-header with-border">
                      <h3 class="box-title">Select Schedules Date Range</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
      ...
      <div class="box">
        <div class="box-header">
          ...
          <div class="box-tools pull-right">
            <a href="addScheduleData.php">Add <?php echo "$pageHead"; ?></a>           
          </div>
        </div><!-- /.box-header -->
        <div class="box-body" id="dataresult-container" >
          ...
          <table id="dataResult" class="display table table-bordered table-hover" cellspacing="0" width="100%">
            <thead>
              <tr>
                <th style="min-width: 10px;">Schedule  ID</th>
                <th style="min-width: 80px;">Schedule Date</th>
                <th style="min-width: 150px;">State</th>
                <th style="min-width: 100px;">Category</th>
                <th>Schedule Narration</th>
...
var viewDataTableCustom = function(whereQuery) {
    var viewDataTable = $('#dataResult').dataTable({ 
      ...
      "ajax": "response/viewSchedulesData.php?"+whereQuery,
      ...
      "drawCallback" : function () {
        loadPopupModalUpdateDelete('schedule','update');
        loadPopupModalUpdateDelete('schedule','delete');
        initHtmlEditPage();
      },            
