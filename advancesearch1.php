				            ...
				            <div class="col-sm-16 bt-space sidebar-widget"> 
				                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				                    <div class="panel panel-default">
				                        <div class="panel-heading" role="tab" id="headingOne" onClick="return searchBody('case_law')">
				                    ...
				                    <div class="panel panel-default">
				                        <div class="panel-heading" role="tab" id="headingTwo" onClick="return searchBody('act')">
				                            <h4 class="panel-title">
				                    ...
				                    <div class="panel panel-default">
				                        <div class="panel-heading" role="tab" id="headingFive" onClick="return searchBody('articles1')">
				                            <h4 class="panel-title">
