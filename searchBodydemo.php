				    ...
				    <!---------- Forms of search options ------------------>        
								...
								?>
									<div class="searchbody">
										<form name="form2" id="form2" action="adv_searchdemo.php" method="GET" class="form padding-b-15" onSubmit="return ValidateForm()">
										   	...
										   	<div class="row" id="state" style="display: none;">
										      	<div class="col-md-16">
										         	<div class="row">
											            ...
											            <div class="col-md-9">
											               	<div class="form-group">
											                  	<?php echo getStatDropdown($_REQUEST['state_id'],'state_id');?>
											               	</div>
											            </div>
										         	</div>
										      	</div>
						                                 	...
						                                 	<div class="form-group">
						                                    	<div class="form-group">
						                                       		<select name="type" id="type" class="form-control">
							                                          	<option value="Acts" <?php if(isset($_REQUEST['type']) && ($_REQUEST['type']=="Acts")){echo "selected:selected";}?>>Acts</option>
																		<option value="Rules" <?php if(isset($_REQUEST['type']) && $_REQUEST['type']=="Rules"){echo "selected:selected";}?>>Rules</option>
						                                       		</select>
						                                    	</div>
						                                 	</div>
						                              	</div>
											             	...
											             	<div class="form-group">
											                	<select id='court' name='court' class="form-control">
											                		<option value="0" <?php if(isset($_REQUEST['court']) && ($_REQUEST['court'] == "0")){ echo "selected=selected";}?>data-dbsuffix="0">Select</option>
											                   		<option value="SC" <?php if(isset($_REQUEST['court']) && ($_REQUEST['court'] == "SC")){ echo "selected=selected";}?>data-dbsuffix="0">Superme Court</option>
	...
	$("#prod_id").change(function(){
		...
		if(val=='1' || val=='2' || val=='4' || val=='5' || val=='6' || val=='7' || val=='8' || val=='9' || val=='10')
		{
			$.ajax({
            	...
            	url  :"adv_search_notification_type_demo.php", //php page URL where we post this data to view from database
            	type :'POST',
            	dataType: 'html',  
