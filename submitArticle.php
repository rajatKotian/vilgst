...
if(isset($_POST['submit'])) {
	...
	//exit();
		...
		if(move_uploaded_file($_FILES['txtUploadArticle']['tmp_name'], "uploads/" . $txtUploadArticle ))  {
			...
			echo "<script>window.alert('Thank You for your uploading your Article, we will publish and circulate it at the earliest.');</script>";
...
<div class="col-md-11 col-sm-9 left-section">
	...
	<div class="col-md-16 col-sm-16"><p class="alert alert-warning">We would like to invite you to partner with us and get your Article published on our website. You can upload your article here and we will publish the same with giving you the due credit. For any clarification, kindly contact us at support@vilgst.com</p></div>
	...
	<div class="col-md-7 table-container align-article">
		<form name="agreeForm" class="form">
	      	...
	      	<ul class="list-unstyled submit-article-list">
				<li>The Article must be in Word format.</li> 
				<li>Authors name, email-id and contact number is mandatorily required.</li> 
				<li>Please attach color passport size photograph (optional).</li>
				<li>Please ensure that that the Article is original and does not infringe copyright of any individual, firm, company etc. In case of any such infringement, the author of article shall be personally liable for consequent damages.</li> 
				<li>The article must not have been published earlier and/or sent for publication elsewhere.</li> 
				<li>VATinfoline Multimedia has the sole discretion to accept or reject the article for publication on its website or to publish it with modification and editing, as it may consider appropriate.</li>
...
function ValidateForm(){
	if (localStorage.getItem("ArticleTermsSubmit") != 'Yes') {
		...
		alert("Please agree with the given 'Terms and Conditions'.")
		return false
