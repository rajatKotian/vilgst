...
//                print_r($row);
                ...
                $PrevPageUrl = getPrevSectionURL($c_section_seq_no, $ChapterId, $ChapterSEQNo, $section_type, $section_act_type);
                $NextPageUrl = getNextSectionURL($c_section_seq_no, $ChapterId, $ChapterSEQNo, $section_type, $section_act_type);
            } else {
                $file_path = $row['file_path'];
            }
            ...
            //     $ChaptersNo = $row['chapter_no'];
            //     $ChaptersId = $row['chapter_id'];
            //     $Chapter_Date = DateTime::createFromFormat('Y-m-d', $row['chapter_date'])->format('d-m-Y');

            //     $destination_Path = '/data/GSTCouncilMeeting/';

            //     $PrevPageUrl = getPrevGSTCouncilMeetingURL($MeetingNumber, $ChaptersId, $ChaptersNo);
            //     $NextPageUrl = getNextGSTCouncilMeetingURL($MeetingNumber, $ChaptersId, $ChaptersNo);
            // } else {
            //     $file_path = $row['file_path'];
            // }
                    ...
                    <h1>
                        ...
                        if ((isset($_GET['page']) && $_GET['page'] == "recent") || (isset($_GET['datatable']) && $_GET['datatable'] != 'undefined')) {
                            ...
                            if ($section_type == 'Section') {
                                ...
                                echo "<span style='font-size: 16px; color: #666;'>THE LIMITATION ACT</span> |  $section_type";
                            }
                        } else if (isset($_GET['showGSTCouncilMeeting'])) {
...
//                                    echo $rowProduct['ProductName'];die;
                                    ...
                                    <div id='rightDisplayBordered' class="bordered" style="width:<?php echo $bordered_width;?>;float:right">
                                        ...
                                        <iframe onLoad="calcHeight();" <?php echo $isPDFLink ; ?>   id='iFramePopupFrame' name='iFramePopupFrame' <?php
                                            ...
                                            if ($file_extn == 'pdf') { ?> src='<?php echo $getBaseUrl . $destination_Path . $file_path; ?>' <?php
                                            } 
                                            else { ?> src='<?php echo "-?l=" . encrypt_url($getBaseUrl . $destination_Path . $file_path); ?>' <?php
                                            } ?> frameborder='0' allowtransparency='true' scrolling='no' width="100%" <?php
