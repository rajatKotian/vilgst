	...
	else if(mysqli_num_rows($result) == 1)
	{
    	...
    	$user_message = "<html>
    					...
    					<body>
    						...
    						<tr>
    						<td>Dear User,
    						Your user-id and password for accessing www.vilgst.com is as below:
    						<br><br> <strong>User-id : </strong>". $usernameTxt ." <br><br> <strong>Password :</strong> ". $pwd." 
    						<br><br> For any further assistance kindly contact us as support@vilgst.com
    						<br><br>THIS IS AN AUTO GENERATED EMAIL, PLEASE DON’T REPLY TO IT.
    						<br><br>Regards
    						<br><br>VATinfoline Multimedia
    						<br><br>www.vilgst.com
    						<br><br>Phone: 9833019272
    						<br><br>
        ...
        mail($emailID, 'Forgot Password Request', $user_message, $mailheaders);
        echo "success";
